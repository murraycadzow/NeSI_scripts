...
#SBATCH --mem-per-cpu=50240  # memory/cpu (in MB)
...
cd $TMP_DIR && srun python ~/.local/bin/selection_pipeline  --vcf $DIR/OMNI_chr${i}_aligned.vcf -c ${i} --config-file $DIR/../defaults_nesi-wm.cfg --maf 0.01 --hwe 0.001 --TajimaD 30 --fay-Window-Width 30 --fay-Window-Jump 30 --ehh-window-size 10 --ehh-overlap 2 --big-gap 200 --small-gap 20 --small-gap-penalty 20 --population OMNI --cores 4 --imputation --impute-split-size 5 --no-clean-up --no-ihs
